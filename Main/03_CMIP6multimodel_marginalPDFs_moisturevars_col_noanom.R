...
jpeg(paste0(figdir, '/CMIP6multimodel_', mvartype, '-marginalPDFs_withbaseline_noanom_demp_JJA-allmodels_col.jpeg'), width = 3.5/1.4, height = 12/1.4, units = 'in', res = 300)
