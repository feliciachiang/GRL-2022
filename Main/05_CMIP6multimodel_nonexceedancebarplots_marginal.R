...
#read in csv file
nonexceeds <- read.csv(paste0(resultsdir, '/CMIP6multimodel_', mvartype, vartype, '-nonexceeding-degree75th-JJA-allmodels.csv'))
...
nonexceeds[equivpercent[,2:4] > 0.99] = NaN
...
colnames(nonexceedsdf) <- c('1 Degree', '2 Degrees', '3 Degrees')
...
jpeg(paste0(figdir, '/CMIP6multimodel_', mvartype, vartype, '-nonexceeding-degree75th-JJA-allmodels-barplot.jpeg'), width = 8, height = 4, units = 'in', res = 300)
